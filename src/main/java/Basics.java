...
public class Basics {
    ...
    public static void main(final String[] args) {
         ...
         */
        var my_variable = 100;
        // but just why would you name something in snake_case when everything else is camelCase in Java?
         ...
         * Current count: 0
         */
        IntStream.range(0, 11).forEach(i -> System.out.printf("Current count: %d\n", 10 - i));
    }
...
//        StringBuilder ret = new StringBuilder();
        ...
        return Arrays.stream(to_split.split(" "))
